...
- *Systemd/SysVinit*: Depending on the initialization system (like systemd or SysVinit), the init process takes over, starting essential services and setting up the user environment.
** 8. User Space
